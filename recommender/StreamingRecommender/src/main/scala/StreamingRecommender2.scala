import StreamingRecommender.{MAX_SIM_MOVIES_NUM, MAX_USER_RATINGS_NUM, MONGODB_MOVIE_RECS_COLLECTION, MONGODB_RATING_COLLECTION, MONGODB_STREAM_RECS_COLLECTION, computMovieScores, getTopSimMovies, getUserRecentlyRating, saveRecsToMongoDB}
